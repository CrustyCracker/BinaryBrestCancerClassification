...
class BinaryClassificationModel():
    ...
    def get_accuracy(self) -> float:
        ...
        if self._accuracy is None:
            raise ValueError(
                "Accuracy has not been or cannot be calculated (devision by zero). \
                 Use calculate_quality() first.")
    ...
    def get_recall(self) -> float:
        ...
        if self._recall is None:
            raise ValueError(
                "Recall has not been or cannot be calculated (devision by zero). \
                 Use calculate_quality() first.")
        return self._recall
    ...
    def get_sensitivity(self) -> float:
        ...
        if self._sensitivity is None:
            raise ValueError(
                "Sensitivity has not been or cannot be calculated (devision by zero). \
                 Use calculate_quality() first.")
    ...
    def get_specificity(self) -> float:
        ...
        if self._specificity is None:
            raise ValueError(
                "Specificity has not been or cannot be calculated (devision by zero). \
                 Use calculate_quality() first.")
    ...
    def get_precision(self) -> float:
        ...
        if self._precision is None:
            raise ValueError(
                "Precision has not been or cannot be calculated (devision by zero). \
                 Use calculate_quality() first.")
    ...
    def get_f1_score(self) -> float:
        ...
        if self._f1_score is None:
            raise ValueError(
                "F1 score has not been or cannot be calculated (devision by zero). \
                 Use calculate_quality() first.")
    ...
    def get_support(self) -> float:
        ...
        if self._support is None:
            raise ValueError(
                "Support has not been or cannot be calculated (devision by zero). \
                 Use calculate_quality() first.")
    ...
    def calculate_quality(self, y_true, y_pred, cutoff=0.5) -> None:
    ...
    def _calculate_roc_curve(self, y_true, y_pred, cutoffs: list) -> None:
        ...
        self._calulate_auc()
        self.calculate_quality(y_true, y_pred)

    def plot_roc_curve(self, axs, y_true, y_pred, cutoffs: list):
        ...
        axs.set_title(f"{self.name} AUC: {self._auc:.3f}")

    def plot_confusion_matrix(self, axs):
    ...
    def __str__(self) -> str:
        string = f"BinaryClassificationModel: {self.name}\n"
